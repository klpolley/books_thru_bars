...
/* jshint ignore:start */
var testRunner = require('jquery-mockjax-2.5.0/qunit-puppeteer.js');
/* jshint ignore:end */
...
module.exports = function(grunt) {
	...
	var config = require('jquery-mockjax-2.5.0/grunt-config-options');
	...
	grunt.registerTask('build', ['dev', 'concat', 'uglify', 'test:chart.js']);
	...
	/* jshint ignore:end */
		...
		var versionUrls = require('jquery-mockjax-2.5.0/test/build-version-urls')(grunt.config, arguments[0], arguments[1], arguments[2]);
